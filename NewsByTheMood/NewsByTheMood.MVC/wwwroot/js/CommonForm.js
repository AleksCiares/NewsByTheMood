class CommonForm {
    ...
    /*document.getElementById(commonForm_formId).addEventListener("submit", async function (event) {
        event.preventDefault();

        const form = event.target;
        const validator = $(form).validate();
        const submitButton = document.getElementById(commonForm_submitButtonId);
